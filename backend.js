      ...
      table.find('tr').each((j, row) => {
        ...
        if (!matchFound && rowMatchId === MATCH_ID) {
          currentMatchData = {
            ...
            flag2: getFullFlagUrl($(tds[8]).find('img').attr('src')) || getFullFlagUrl($(tds[9]).find('img').attr('src')) || getFullFlagUrl($(tds[10]).find('img').attr('src')),
        ...
        // 2. Szukaj historii meczów gracza
